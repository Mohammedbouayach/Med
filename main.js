...
let n2= out*0.25 ;
let n3=ou*0.5 ;
/*document.getElementById("result").innerHTML=10-(n1+n2);*/
...
function ba9(){
  let mr =document.getElementById("ba9i1").value;
  let lj =document.getElementById("ba9i2").value;
  let b1 = mr*0.25
  let b2 = lj*0.25
  document.getElementById("ba9i").innerHTML=10-(b1+b2);
}